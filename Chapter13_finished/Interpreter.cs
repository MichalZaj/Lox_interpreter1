...
namespace Lox_Interpreter1
{
    public class Interpreter : Expr.IVisitor<object>, Stmt.IVisitor<object>
    {
        ...
        public object VisitSuperExpr(Expr.Super expr)
        {
            ...
            LoxClass superclass = (LoxClass)environmentLox.GetAt(distance, "super");
            LoxInstance obj = (LoxInstance)environmentLox.GetAt(distance - 1, "this");
        ...
        private object LookUpVariable(Token name, Expr expr)
        {
            ...
            {
                return environmentLox.GetAt(distance, name.Lexeme);
            }
            else
            {
        ...
        public object VisitClassStmt(Stmt.Class stmt)
        {
            ...
            environmentLox.Define(stmt.Name.Lexeme, null);
            if (stmt.Superclass != null)
            {
                environmentLox = new EnvironmentLox(environmentLox);
                environmentLox.Define("super", superclass);
            }
            Dictionary<string, LoxFunction> methods = new Dictionary<string, LoxFunction>();
            foreach (Stmt.Function method in stmt.Methods)
            {
                LoxFunction function = new LoxFunction(method, environmentLox, method.Name.Lexeme.Equals("init"));
            ...
            if (superclass != null)
            {
                environmentLox = environmentLox.enclosing;
            }
            environmentLox.Assign(stmt.Name, klass);
            return null;
        }
        ...
        {
            LoxFunction function = new LoxFunction(stmt, environmentLox, false);
        ...
        public object VisitAssignExpr(Expr.Assign expr)
        {
            ...
            {
                environmentLox.AssignAt(distance, expr.Name, value);
            }
            else
            {
